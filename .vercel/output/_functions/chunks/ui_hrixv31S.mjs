...
const ui = {
  en: {
      ...
      sampleProject: {
        ...
        keyFeatures: {
          ...
          contentManagement: {
            ...
            description: "Allows for easy content management via Markdown files or a CMS."
          }
        },
        galleryImages: {
    ...
    homePage: {
      ...
      pageDescription: "Welcome to the portfolio of YOUR_NAME, a FullStack developer passionate about creating innovative web experiences.",
      ...
      heroImageAlt: "Illustration representing YOUR_NAME or a development concept",
  ...
  ko: {
    projectsContent: {
      sampleProject: {
        ...
        dateText: "2025년 1월",
        detailedDescription: "프로젝트 상세 페이지의 콘텐츠 구조를 보여주는 샘플 프로젝트에 대한 자세한 설명입니다.",
        keyFeatures: {
          responsiveDesign: {
            title: "반응형 디자인",
          ...
          contentManagement: {
            title: "쉬운 콘텐츠 관리",
            description: "마크다운 파일이나 CMS를 통해 쉽게 콘텐츠를 관리할 수 있습니다."
          }
        },
        galleryImages: {},
    ...
    homePage: {
      ...
      pageDescription: "혁신적인 웹 경험을 만드는 것을 좋아하는 풀스택 개발자 YOUR_NAME의 포트폴리오에 오신 것을 환영합니다.",
      ...
      featuredProjectsDescription: "최근에 작업한 몇 가지 프로젝트입니다. 자유롭게 둘러보세요!",
      projectCardViewProject: "프로젝트 보기",
      projectCardViewCode: "코드 보기",
      imageNotAvailable: "이미지를 사용할 수 없습니다",
      mySkillsTitle: "내 기술",
      mySkillsDescription: "제 작업과 열정을 정의하는 전문성과 능력을 탐색해보세요."
    },
    blogPage: {
      pageTitle: "나의 기술 블로그",
      pageDescription: "웹 개발, 소프트웨어 아키텍처, 신기술에 대한 기사와 생각.",
      title: "나의 기술 블로그",
      description: "웹 개발, 소프트웨어 아키텍처, 신기술에 대한 기사와 생각.",
    ...
    contactPage: {
      pageTitle: "연락하기",
      pageDescription: "당신의 프로젝트, 잠재적인 협업에 대해 이야기하거나 기술에 대해 이야기 나눠봐요!",
      title: "연락하기",
      description: "당신의 프로젝트, 잠재적인 협업에 대해 이야기하거나 기술에 대해 이야기 나눠봐요!",
      formTitle: "메시지 보내기",
      firstNameLabel: "이름",
      lastNameLabel: "성",
      emailLabel: "이메일",
      ...
      calendarTitle: "회의 예약",
      calendarDescription: "실시간으로 대화하고 싶으신가요? 제 캘린더에서 직접 시간을 예약하세요.",
  ...
  return function t(key) {
    ...
    if (featureTranslations) {
      ...
      if (keyTyped in featureTranslations) {
        return featureTranslations[keyTyped];
      }
    }
    const defaultFeatureTranslations = ui[defaultLanguage]?.[feature];
    if (defaultFeatureTranslations) {
      const keyInDefaultTyped = key;
      if (keyInDefaultTyped in defaultFeatureTranslations) {
        return defaultFeatureTranslations[keyInDefaultTyped];
      }
    }
    return key;
  };
